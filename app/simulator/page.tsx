  ...
  return (
    <>
      <PageHeader
        ...
        description="The identify layer. 52 researched vectors, six of which are deeply implemented and executable against the simulator. The distinction is explicit on every card."
      >
        {summary && (
          <>
